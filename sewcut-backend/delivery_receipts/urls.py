...
from .email_views import preview_delivery_receipt_pdf, send_delivery_receipt_email, schedule_delivery_receipt_email
...
urlpatterns = [
    ...
    path('<int:pk>/schedule-email/', schedule_delivery_receipt_email, name='delivery-receipt-schedule-email'),
