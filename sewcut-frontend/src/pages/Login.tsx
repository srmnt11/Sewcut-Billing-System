...
import { AlertCircle, Loader2, FileText, Eye, EyeOff, CheckCircle2, BarChart3, Users } from 'lucide-react';
        ...
        <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden flex-col justify-between p-12"
          ...
          <div className="relative z-10 animate-fade-slide-right">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-gradient-to-br from-orange-400 to-orange-600 rounded-2xl flex items-center justify-center shadow-xl logo-pulse">
                <FileText className="w-8 h-8 text-white" />
              </div>
              <div>
                <h2 className="text-white text-2xl font-bold tracking-tight">Sewcut</h2>
          ...
          <div className="relative z-10 space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl font-extrabold text-white leading-tight tracking-tight"
                ...
                <span className="text-transparent bg-clip-text"
                  style={{ backgroundImage: 'linear-gradient(90deg, #f97316, #fb923c, #fbbf24)' }}>
                  Billing & Operations
                </span>
              </h1>
              <p className="text-slate-300 text-lg leading-relaxed max-w-sm"
                style={{ animation: 'fadeSlideUp 0.7s ease-out 0.25s both' }}>
                Manage invoices, quotations, and client relationships all in one place.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                { icon: <CheckCircle2 className="w-5 h-5" />, text: 'Auto-generate professional PDF invoices & quotations' },
                { icon: <BarChart3 className="w-5 h-5" />, text: 'Real-time revenue analytics and growth tracking' },
                { icon: <Users className="w-5 h-5" />, text: 'Centralized client and supplier management' },
              ].map((f, i) => (
                <div key={i} className="feature-item flex items-center gap-3">
                  <div className="flex-shrink-0 w-9 h-9 rounded-xl bg-orange-500/20 border border-orange-500/30 flex items-center justify-center text-orange-400">
                    {f.icon}
                  </div>
            ...
            {/* Floating stats card */}
            <div className="animate-float2 inline-block"
              style={{ animationDelay: '1s' }}>
              <div className="flex items-center gap-4 bg-white/5 backdrop-blur border border-white/10 rounded-2xl px-5 py-4 shadow-xl">
                ...
                <div className="text-center">
                  <p className="text-2xl font-bold text-orange-400">Auto</p>
                  <p className="text-xs text-slate-400 mt-0.5">PDF Gen</p>
                </div>
                <div className="w-px h-10 bg-white/10" />
                <div className="text-center">
        ...
        <div className="flex-1 flex items-center justify-center p-8 bg-slate-50 relative overflow-hidden">
          ...
          <div className="w-full max-w-md relative z-10 login-card">
            ...
            <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 p-8
                            transition-shadow duration-300 hover:shadow-2xl hover:shadow-slate-200/80">
              ...
              <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className={`input-glow rounded-lg border ${errors.username && touched.username ? 'border-red-400' : 'border-slate-200 hover:border-slate-300'}`}>
                    <Input
                      id="username"
                      type="text"
                      value={username}
                      ...
                      className="border-0 shadow-none focus-visible:ring-0 bg-slate-50/50 rounded-lg h-11 text-sm"
                      disabled={isLoading}
                    />
                  </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className={`input-glow rounded-lg border relative ${errors.password && touched.password ? 'border-red-400' : 'border-slate-200 hover:border-slate-300'}`}>
                    <Input
                      id="password"
                      ...
                      className="border-0 shadow-none focus-visible:ring-0 bg-slate-50/50 rounded-lg h-11 text-sm pr-10"
                      disabled={isLoading}
                    />
                    <button
                      type="button"
                ...
                <div className="pt-1">
                  <button
                    ...
                    className="btn-shimmer w-full h-11 rounded-xl text-white font-semibold text-sm
              ...
              <div className="mt-6 flex items-center gap-3">
                ...
                <p className="text-xs text-slate-400 font-medium">Sewcut Admin Dashboard</p>
                <div className="flex-1 h-px bg-slate-100" />
              </div>
            </div>
          </div>
