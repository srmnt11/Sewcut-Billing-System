          ...
          <div className="hero-stat-row flex flex-wrap items-center gap-x-6 gap-y-3 mt-5">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-slate-800 text-sm font-semibold truncate">{reportTypes.length}</p>
                <p className="text-slate-500 text-xs truncate">Report Types</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-slate-500 text-xs truncate">Clients</p>
              </div>
            </div>
          </div>
        </div>
