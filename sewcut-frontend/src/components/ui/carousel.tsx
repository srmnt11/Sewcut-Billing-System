...
const Carousel = React.forwardRef<HTMLDivElement, CarouselProps>((
  ...
  const onSelect = React.useCallback((api: { canScrollPrev: () => boolean | ((prevState: boolean) => boolean); canScrollNext: () => boolean | ((prevState: boolean) => boolean); }) => {
    if (!api) {
      return
    }
  ...
  const handleKeyDown = React.useCallback((event: { key: string; preventDefault: () => void; }) => {
