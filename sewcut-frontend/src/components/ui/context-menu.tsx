...
const ContextMenuCheckboxItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.CheckboxItem> & { className?: string; children?: React.ReactNode }
...
const ContextMenuRadioItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.RadioItem> & { className?: string; children?: React.ReactNode }
